...
class HParams(AttrDict):
  # Note: This is a minimal no-dependencies version of tensorflow.contrib.training.HParams
  # I do not endorse of use of HParams, but this follows the same exact API for compatibility
